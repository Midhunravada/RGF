...
const Home = () => {
  ...
  <div className="hero-actions">
    ...
    {/* ⭐ NEW BUTTONS: Profile + Submission History */}
    <Link to="/profile" className="btn btn-outline btn-large">Profile</Link>
    <Link to="/submission-history" className="btn btn-outline btn-large">Submission History</Link>
  </div>
)}
